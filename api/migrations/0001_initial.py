...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Order',
            fields=[
                ('order_id', models.CharField(default='ZA786', max_length=10, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('work_staff_completion_stage', models.CharField(choices=[('cutting', 'CUTTING'), ('stitching', 'STITCHING'), ('hook', 'HOOK'), ('overlock', 'OVERLOCK')], max_length=50)),
                ('work_completed_date_time', models.DateTimeField(auto_now=True)),
                ('work_staff_comp_app_date_time', models.DateTimeField(auto_now=True)),
                ('work_staff_completion_approved', models.BooleanField(default=False)),
                ('order_next_stage_assign', models.BooleanField(default=False)),
                ('order', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.order')),
