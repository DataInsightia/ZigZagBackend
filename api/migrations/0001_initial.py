    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance_amount', models.IntegerField(blank=True)),
                ('balance_amount', models.IntegerField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_staff_comp_app_date_time', models.DateTimeField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.order')),
                ('orderworkstatuscompletion', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.orderworkstaffstatuscompletion')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.order')),
                ('staff', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.staff')),
                ('staffworkwage', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.staffworkwage')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='staff',
            field=models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.staff'),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('material', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.material')),
                ('order', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='api.order')),
            ],
        ),
        migrations.CreateModel(
